...
import functools
from typing import Any, Callable, List, Mapping, NamedTuple, Optional, Sequence, Tuple, Union, Dict
...
def load_model(ckpt_path=None, model_size='base'):
  if ckpt_path is None:
    ...
    # Always load to CPU first to avoid device mismatch during reload
