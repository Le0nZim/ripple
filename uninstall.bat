...
REM   - Portable JDK/Maven (tools/)
REM   - Environment stamp (.ripple-env.stamp)
REM
REM This script does NOT uninstall:
REM   - System Java/JDK the user already had
REM   - Conda/Miniconda/Anaconda (including %USERPROFILE%\miniconda3)
...
REM =============================================================================
REM Remove portable JDK/Maven and env stamp
REM =============================================================================
echo [5/6] Removing portable tools and install stamp...
if exist "%~dp0tools" (
    rmdir /s /q "%~dp0tools" 2>nul
    echo   [OK] tools/ directory removed (portable JDK/Maven)
) else (
    echo   [OK] tools/ directory not found
)
if exist "%~dp0.ripple-env.stamp" (
    del "%~dp0.ripple-env.stamp" 2>nul
    echo   [OK] .ripple-env.stamp removed
)

REM =============================================================================
REM Remove Python cache
REM =============================================================================
echo [6/6] Cleaning up cache files...
