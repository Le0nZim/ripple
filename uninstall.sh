...
#   - Portable JDK/Maven (tools/)
#   - Environment stamp (.ripple-env.stamp)
#
# This script does NOT uninstall:
#   - System Java/JDK the user already had
#   - Conda/Miniconda/Anaconda (including ~/miniconda3)
...
echo "  - Portable JDK/Maven downloaded into tools/"
echo ""
echo "This will NOT uninstall system Java, Miniconda, or system Maven."
echo ""
...
# =============================================================================
echo -e "${BLUE}[1/6] Removing conda environment...${NC}"
if [[ -z "$CONDA_BIN" ]]; then
...
# =============================================================================
echo -e "${BLUE}[2/6] Removing desktop shortcuts...${NC}"
REMOVED_SHORTCUTS=0
...
# =============================================================================
echo -e "${BLUE}[3/6] Removing generated launchers...${NC}"
REMOVED_LAUNCHERS=0
...
# =============================================================================
echo -e "${BLUE}[4/6] Removing build artifacts...${NC}"
...
# =============================================================================
# Remove portable JDK/Maven and env stamp
# =============================================================================
echo -e "${BLUE}[5/6] Removing portable tools and install stamp...${NC}"
if [[ -d "${SCRIPT_DIR}/tools" ]]; then
    rm -rf "${SCRIPT_DIR}/tools"
    echo -e "  ${GREEN}✓${NC} tools/ directory removed (portable JDK/Maven)"
else
    echo -e "  ${GREEN}✓${NC} tools/ directory not found"
fi
if [[ -f "${SCRIPT_DIR}/.ripple-env.stamp" ]]; then
    rm -f "${SCRIPT_DIR}/.ripple-env.stamp"
    echo -e "  ${GREEN}✓${NC} .ripple-env.stamp removed"
fi

# =============================================================================
# Remove Python cache
# =============================================================================
echo -e "${BLUE}[6/6] Cleaning up cache files...${NC}"
...
echo "  - Portable JDK/Maven (tools/)"
echo "  - Environment stamp (.ripple-env.stamp)"
echo ""
